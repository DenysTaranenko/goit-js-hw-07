...
// Створення масиву елементів img
...
// Створення елементу li, який включає в себе елемент img
const galleryElements = imagesElements.map((imgElement) => {
...
galleryElements.forEach((liElement) => {
